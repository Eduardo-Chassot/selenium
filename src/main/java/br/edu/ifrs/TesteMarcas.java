...
public class TesteMarcas {
	...
	@Test
	public void t01_deveCastrarNovaMarca() throws IOException, InterruptedException {
		page.novo();
		page.setNome(nome);
		page.salvar();	
	...
	@Test
	public void t02_validaCadastroMarca() throws IOException, InterruptedException {
	...
	@Test
	public void t05_deveEditarMarca() throws IOException {
	...
	public void t06_deveExcluirMarca() throws IOException {
